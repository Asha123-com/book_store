...
import 'package:book_store/model/sign%20in%20model.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Registration",style: myStyle(30,Colors.black),),
        centerTitle: true,
      ),
                ...
                child: Column(
                  children: [
                    ...
                    MaterialButton(
                      ...
                      child: Text(
                        "Register Now",
                        style: style(18, Colors.black,FontWeight.bold),
                      ),
                    ),
                  ],
                ),
